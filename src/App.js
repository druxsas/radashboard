...
export default function DashboardDesktop() {
  return (
    <div className="bg-[#faf9ff] relative size-full min-h-screen" data-name="dashboard-desktop" data-node-id="17:3">
      ...
      {/* Main Content */}
      <div className="absolute bg-[#faf9ff] box-border content-stretch flex flex-col gap-6 h-full items-start justify-start left-[319px] top-0 w-[calc(100%-319px)]" data-name="main-content" data-node-id="17:64">
        {/* Header */}
        <Header />
