...
export default function Header() {
  ...
  return (
    <div ref={headerRef} className="bg-white box-border content-stretch flex items-center justify-start px-6 py-6 relative w-full border-b border-[#d9d8d8]" data-node-id="17:61">
