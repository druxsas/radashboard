...
export default function Sidebar() {
  ...
  return (
    <div ref={sidebarRef} className="absolute bg-white box-border content-stretch flex flex-col gap-4 h-full items-start justify-start left-0 p-[24px] top-0 w-[319px]" data-name="menu-open" data-node-id="17:4">
      ...
      {/* Logo Section */}
      <div className="box-border content-stretch flex items-center justify-start px-0 relative shrink-0 w-full border-b border-[#d9d8d8]" style={{paddingTop: '1rem', paddingBottom: '1.8rem'}} data-node-id="17:5">
