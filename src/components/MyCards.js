...
export default function MyCards() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-6 items-start justify-start p-6 relative rounded-[16px] shrink-0 w-[320px]" data-name="my-cards" data-node-id="17:124">
