...
export default function YearlyCardActivity() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-6 items-start justify-start p-6 relative rounded-[16px] h-full" style={{flexBasis: '70%'}} data-name="yearly-card-activity" data-node-id="17:113">
